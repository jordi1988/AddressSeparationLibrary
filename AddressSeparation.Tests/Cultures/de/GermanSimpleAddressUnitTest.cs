...
namespace AddressSeparation.Tests.Cultures
{
    public class GermanSimpleAddressUnitTest
    {
        ...
        private static object[] TestAddressesShortenManipulation =
        {
            // Streets only
            new object[] { "Vattmannstr.", "Vattmannstr.", null, "" },
            new object[] { "Vattmannstraﬂe", "Vattmannstr.", null, "" },
            new object[] { "Vattmannstrasse", "Vattmannstr.", null, "" },
            new object[] { "Berliner-Straﬂe", "Berliner-Str.", null, "" },
            new object[] { "Berliner Straﬂe", "Berliner Str.", null, "" },
            ...
            new object[] { "Vattmannstr. 11a", "Vattmannstr.", (short)11, "A" },
            new object[] { "Vattmannstr. 11 A", "Vattmannstr.", (short)11, "A" },
            new object[] { "Vattmannstraﬂe 11a", "Vattmannstr.", (short)11, "A" },
            new object[] { "Vattmannstraﬂe 11 A", "Vattmannstr.", (short)11, "A" },
